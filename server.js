...
// A GET route for scraping the website
  ...
  axios.get("https://www.awn.com/news").then(function(response) {
    ...
    $("article").each(function(i, element) {
      ...
      let result = {};
      let website = "https://www.awn.com";


      // Add the text and href of every link, and save them as properties of the result object
      result.title = $(this)
        .find(".node-title").find("a")
        .attr("title");
      let link = $(this)
        .find(".node-title").find("a")
        .attr("href");
...
const newArtPull = function(req, res) {
...
const getOneArt = function(req, res) {
